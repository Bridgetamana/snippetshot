    ...
    i =
      ...
      function () {
        return (
          (r += 1),
          'u'
            .concat('0000'.concat(((Math.random() * Math.pow(36, 4)) << 0).toString(36)).slice(-4))
            .concat(r)
        );
      });
  function o(t) {
      ...
      t.toBlob
        ...
        : new Promise(function (n) {
            for (
              var r = window.atob(
                  t
                    .toDataURL(e.type ? e.type : void 0, e.quality ? e.quality : void 0)
                    .split(',')[1]
                ),
                i = r.length,
                o = new Uint8Array(i),
        ...
        switch (e.label) {
          case 0:
            return (
              e.trys.push([0, 3, , 4]),
              (
                null === (r = null == t ? void 0 : t.contentDocument) || void 0 === r
                  ? void 0
                  : r.body
              )
                ? [4, L(t.contentDocument.body, {}, !0)]
                : [3, 2]
            );
          case 1:
            return [2, e.sent()];
          ...
          if (n) {
            ...
            r.cssText
              ...
              : o(r).forEach(function (i) {
                  ...
                  (d(t, HTMLIFrameElement) && 'display' === i && 'inline' === o && (o = 'block'),
                    'd' === i &&
                      e.getAttribute('d') &&
                                ...
                                (e =
                                  ...
                                  t.assignedNodes
                                    ...
                                    : d(t, HTMLIFrameElement) &&
                                      ...
                                      : o(
                                          (null !== (c = t.shadowRoot) && void 0 !== c ? c : t)
                                            .childNodes
                    ...
                    return e(this, void 0, void 0, function () {
                      ...
                      return n(this, function (n) {
                        switch (n.label) {
                          case 0:
                            if (
                              0 === (e = t.querySelectorAll ? t.querySelectorAll('use') : []).length
                            )
                              return [2, t];
                            ((i = {}), (p = 0), (n.label = 1));
                          case 1:
                            ...
                            if ((f = Object.values(i)).length) {
                              for (
                                h = 'http://www.w3.org/1999/xhtml',
                                  (d = document.createElementNS(h, 'svg')).setAttribute('xmlns', h),
  ...
  function j(t, r) {
    return e(this, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            return ((e = d(t, HTMLImageElement)) && !y(t.src)) ||
              (d(t, SVGImageElement) && !y(t.href.baseVal))
              ? [4, C((i = e ? t.src : t.href.baseVal), b(i), r)]
              : [2];
          case 1:
            return (
              (o = n.sent()),
          ...
          switch (n.label) {
            ...
            case 2:
              return (
                ...
                r.backgroundColor &&
                  ((f.fillStyle = r.backgroundColor), f.fillRect(0, 0, s.width, s.height)),
